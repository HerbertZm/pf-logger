  ...
  return (
    <>
      ...
      >
        ...
        <td
          className={`round-row__num${summary.outstandingAtTimeCalled === 0 ? ' value-zero' : ''}`}
        >
          {val(summary.outstandingAtTimeCalled)}
        </td>
        <td
          className="round-row__num value-zero"
          title="Requires ingestion worker — not yet available"
        >
