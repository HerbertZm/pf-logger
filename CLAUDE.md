...
| User guide improvements — rewrite stale USER_GUIDE.md to current app | `plans/user-guide-improvements.md` |
| Demo data update — seed fixture gaps vs current features | `plans/demo-data-update.md` |
